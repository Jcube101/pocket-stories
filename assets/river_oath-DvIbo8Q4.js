...
passages:
  ...
  crates:
    ...
    choices:
      ...
      - text: "Take nothing — speak to the ferryman"
        target: ferryman

  crates_token:
    text: |
      Lantern in hand. The rusted token still sits in the crate.
    choices:
      - text: "Take the token too"
        target: ferryman
        effect: "inventory.ferry_token = true"
      - text: "The lantern is enough"
        target: ferryman
  ...
  crossing:
    ...
    choices:
      ...
      - text: "Invoke Mira's trust as your pledge"
        target: good_end
        condition: "relationships.Mira >= 2"
      - text: "Stay silent"
        target: neutral_end
